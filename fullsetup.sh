...
curl --request POST \
  ...
  --data '{"personalizations": [{"to": [{"email": "'${DEST_EMAIL}'"}]}],"from": {"email": "doss@genitconfig.me"},"subject": "Generate SSH Public Key","content": [{"type": "text/plain", "value": "Greetings to myself. Here is the public key: \n '${PUBKEY}'"}]}'
